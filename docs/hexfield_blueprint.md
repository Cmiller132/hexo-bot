...
*This blueprint is a conceptual companion to the technical specifications in `docs/specs/hexfield_model_spec.md` (model design & rationale) and `docs/specs/hexfield_eval_v2_spec.md` (evaluation), and to `docs/ARCHITECTURE.md` (where each piece lives in the code).*
