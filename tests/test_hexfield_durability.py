"""Power-cut durability of the hexfield training-IO paths.
...
from hexfield import checkpoints
from hexfield.buffer_manifest import ShardEntry
...
def test_shard_write_roundtrips_through_atomic_path(tmp_path) -> None:
    ...
    assert meta["rows"] == 3 and meta["epoch"] == 1 and meta["schema"] == "hexfield_compact_v1"
