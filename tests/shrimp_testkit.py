"""Shared helpers for the shrimp test suite (not collected by pytest).

Adds packages/shrimp/python to sys.path so tests can import shrimp without
...
sys.path.insert(0, str(_PACKAGES / "shrimp" / "python"))
