...
collate_training -> shrimp_loss, and asserts:
...
import shrimp_testkit  # noqa: F401  (sys.path shim: exposes shrimp + engine)
...
from shrimp.losses import shrimp_loss
...
def test_truncated_rows_masked_completed_unchanged(tmp_path) -> None:
    ...
    def run_loss(rows):
        ...
        with torch.no_grad():
            ...
            total, comps = shrimp_loss(out, batch, denominators=denoms)
