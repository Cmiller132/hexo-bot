...
def _future_opponent_policy(
    decisions: Sequence[tuple[int, "ShrimpSampleData", float]],
    index: int,
    player: int,
    *,
...
def finalize_game_samples(
    pending: Sequence[tuple[int, ShrimpSampleData, float]],
    winner: int | None,
    ...
    *,
    ...
    finalized: list[ShrimpSampleData] = []
