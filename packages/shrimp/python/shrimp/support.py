...
# Model-side support radius. SHRIMP_SUPPORT_RADIUS restricts the support to
...
_SUPPORT_RADIUS = int(os.environ.get("SHRIMP_SUPPORT_RADIUS", "").strip() or LEGAL_RADIUS)
